...
export default function CourseDetailPage({ params }: DetailPageProps) {
  ...
  const intlDeadline = course.internationalApplicationDeadline
    ? new Date(course.internationalApplicationDeadline).toLocaleDateString('en-US')
    : "N/A";

  const domDeadline = course.domesticApplicationDeadline
    ? new Date(course.domesticApplicationDeadline).toLocaleDateString('en-US')
    : "N/A";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card className="overflow-hidden">
              ...
              <CardHeader className="bg-card">
                ...
                <CardDescription className="text-lg flex items-center gap-2 pt-2">
                  <School className="h-5 w-5" /> {course.universityName || "Unknown"}
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="p-6 space-y-8">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground whitespace-pre-wrap">
                    {course.overviewDescription || "No description"}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <DetailItem icon={<Clock />} label="Duration" value={`${course.durationMonths || "N/A"} months`} />
                  <DetailItem icon={<GraduationCap />} label="Credits" value={`${course.credits || "N/A"} credits`} />
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <DetailItem
                  ...
                  value={`${fee ? fee.toLocaleString() : "N/A"} ${currency}`}
                />

                <DetailItem icon={<Calendar />} label="Int'l Deadline" value={intlDeadline} />
                <DetailItem icon={<Calendar />} label="Domestic Deadline" value={domDeadline} />
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <DetailItem icon={<Target />} label="IELTS Score" value={`Minimum ${course.minimumIELTSScore || "N/A"}`} />
